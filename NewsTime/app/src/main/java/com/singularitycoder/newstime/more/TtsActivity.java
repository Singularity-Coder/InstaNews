...
import com.singularitycoder.newstime.BuildConfig;
...
public final class TtsActivity extends AppCompatActivity {
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.isAnyPermissionPermanentlyDenied()) {
                            showSettingsDialog(TtsActivity.this);
                        }
                    }
    ...
    private void checkPermissionsThenDoWork(Callable<Void> work, String permission) {
        if (ActivityCompat.checkSelfPermission(TtsActivity.this, permission) == PackageManager.PERMISSION_GRANTED) {
            try {
                work.call();
            } catch (Exception e) {
                e.printStackTrace();
            ...
            ActivityCompat.requestPermissions(TtsActivity.this, new String[]{permission}, REQUEST_CODE_PERMISSIONS);
        }
        ...
        textToSpeech.setOnUtteranceProgressListener(new UtteranceProgressListener() {
            ...
            public void onDone(String utteranceId) {
                if (utteranceId.equals(UTTERANCE_ID)) {
                    Toast.makeText(TtsActivity.this, "Saved to " + savedAudioFileName, Toast.LENGTH_LONG).show();
                }
